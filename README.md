...
### 시장 데이터
**주가/지수 (KIS) — 장 마감 후 1일 1회 (16:00 KST)**
- **종목** (KIS 현재가): 005930 / 000660 / 005380
- **지수** (KIS 업종 현재지수): 코스피(0001) / 코스닥(1001)
- 현재가 기준. 16:00 KST 호출이라 사실상 마감가 근처 값

**환율 (ExchangeRate-API, 키 불필요) — 매일 09:10 KST 1회**
- USD/KRW. 등락은 **직전 저장값 대비**로 계산 → "전일 대비"
- 첫 수집은 비교 대상이 없어 `null`
